...
\begin{table}[htbp]
\centering
\caption{Performance comparison, Universe U1 (Table~9). Primary
...
\begin{table}[htbp]
\centering
\caption{Six-strategy benchmark comparison (Table~9B): mean $\pm$ std
...
\begin{table}[htbp]
\centering
\caption{Crisis period isolation (Table~10, U1): MDD and CVaR@95\%
...
\begin{table}[htbp]
\centering
\caption{Regime-separated performance (Table~13C): G-CVaR vs Equal
...
\begin{table}[htbp]
\centering
\caption{Walk-forward calibration results (Table~11, U1).
...
\begin{table}[htbp]
\centering
\caption{Four-condition ablation (Table~12, U1). Static-$\lambda$
...
\begin{table}[htbp]
\centering
\caption{Pooled cross-universe statistical tests (Table~13B): 11
...
\begin{table}[htbp]
\centering
\caption{Universe-level Wilcoxon $p$-values: G-CVaR vs Std CVaR
...
\begin{table}[htbp]
\centering
\caption{Monte Carlo survival statistics (Table~14, U1, 10,500 paths).
...
\begin{table}[htbp]
\centering
\caption{Top-10 most penalised stocks (Table~17, U1): mean eigenvector
...
\begin{table}[htbp]
\centering
\caption{HITL decision summary (Table~21, U1). The Constrain action
         re-runs G-CVaR with $w_{\max} = 8\%$, enforcing tighter
         position limits.}
\label{tab:hitl_summary}
\begin{tabular}{lrrrr}
\toprule
...
\begin{table}[htbp]
\centering
\caption{System trustworthiness evaluation (Table~27): four criteria
...
\begin{table}[htbp]
\centering
\caption{HITL governance ablation (Table~26): four conditions across
...
\begin{table}[htbp]
\centering
\caption{MAS vs monolithic architecture (Table~28, U1, 10 windows,
...
\begin{table}[htbp]
\centering
\caption{Cross-universe performance (Table~9A): G-CVaR, Standard CVaR,
