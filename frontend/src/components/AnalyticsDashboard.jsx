...
import { NetworkGraphChart, TimelineChart, BoxplotLikeChart } from './CustomCharts';
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', height: '100vh', width: '100vw', bgcolor: '#0D0D0D', color: '#ECECEC', overflow: 'hidden' }}>
      ...
      <Box sx={{ flexGrow: 1, overflowY: 'auto', p: 3, bgcolor: '#0D0D0D' }}>
        ...
        {activeTab === 5 && (
          <RiskGovernanceTab activeRegime={activeRegime} risk={risk} universe={universe} />
        )}
        ...
        {activeTab === 8 && (
          <BacktestingTab activeRegime={activeRegime} backtest={backtest} universe={universe} />
        )}
