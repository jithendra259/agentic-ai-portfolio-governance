...
const PLOT_FIXTURES = [
  ...
  { id: 'test-smart-bar', label: 'Smart Bar' },
  { id: 'test-scatter', label: 'Scatter' },
  { id: 'test-sankey', label: 'Sankey' },
  { id: 'test-heatmap', label: 'Heatmap' },
  { id: 'test-funnel', label: 'Funnel' },
  { id: 'test-radar', label: 'Radar' },
  { id: 'test-gauge', label: 'Gauge' },
  { id: 'test-radial-bar', label: 'Radial Bar' },
  { id: 'test-radial-line', label: 'Radial Line' },
